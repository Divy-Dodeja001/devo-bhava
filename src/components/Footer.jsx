      ...
      <footer id="footer-section">
        <div className="position-relative" style={{ height: "100%" }}>
          ...
          <div className="container container-xl px-4">
            ...
            <div className="position-absolute" style={{ bottom: "5%", right:"10%" }}>
                <div className="d-flex align-items-center" style={{gap:"0.3em"}}>
                    <div>
                        <Link to="/" className="text-decoration-none">
                        <img src="/public/twitter.png" className="social-media-icons"></img></Link>
                    </div>
                    <div>
                        <Link to="/" className="text-decoration-none">
                        <img src="/public/facebook.png" className="social-media-icons"></img></Link>
                    </div>
                    <div>
                        <Link to="/" className="text-decoration-none">
                        <img src="/public/instagram.png" className="social-media-icons"></img></Link>
                    </div>
                    <div>
                        <Link to="/" className="text-decoration-none">
                        <img src="/public/vimeo.png" className="social-media-icons"></img></Link>
                    </div>
                </div>
            </div>
          </div>
